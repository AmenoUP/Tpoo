defmodule TpooWeb.WorkingtimeControllerTest do
  use TpooWeb.ConnCase
  ...
  @update_attrs %{
    start: ~U[2024-10-08 10:39:00Z],
    end: ~U[2024-10-08 10:39:00Z]
  }
  ...
  describe "create workingtime" do
    test "renders workingtime when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2024-10-07T10:39:00Z",
               "start" => "2024-10-07T10:39:00Z"
  ...
  describe "update workingtime" do
    ...
    test "renders workingtime when data is valid", %{conn: conn, workingtime: %Workingtime{id: id} = workingtime} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2024-10-08T10:39:00Z",
               "start" => "2024-10-08T10:39:00Z"
             } = json_response(conn, 200)["data"]
    end
